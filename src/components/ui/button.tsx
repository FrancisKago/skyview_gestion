...
export function Button({ variant = 'primary', pending, children, className = '', disabled, type = 'button', ...rest }: Props) {
  ...
  return (
    <button type={type} disabled={disabled || pending} className={`${base} ${look} ${className}`} {...rest}>
